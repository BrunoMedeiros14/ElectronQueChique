...
export const apiCliente = {
  ...
  removerCliente: (
    ...args: Parameters<RemoverCliente>
  ): ReturnType<RemoverCliente> =>
    ipcRenderer.invoke('removerCliente', ...args),
  editarCliente: (
    ...args: Parameters<EditarCliente>
  ): ReturnType<EditarCliente> => ipcRenderer.invoke('editarCliente', ...args),
  buscarClientePorId: (
    ...args: Parameters<BuscarClientePorId>
  ): ReturnType<BuscarClientePorId> =>
    ipcRenderer.invoke('buscarClientePorId', ...args),
  buscarTodosClientes: (
    ...args: Parameters<BuscarTodosClientes>
  ): ReturnType<BuscarTodosClientes> =>
    ipcRenderer.invoke('buscarTodosClientes', ...args),
}

export const apiCaixa = {
  criarCaixa: (...args: Parameters<CriarCaixa>): ReturnType<CriarCaixa> =>
    ipcRenderer.invoke('criarCaixa', ...args),
  ...
  buscarCaixaPorId: (
    ...args: Parameters<BuscarCaixaPorId>
  ): ReturnType<BuscarCaixaPorId> =>
    ipcRenderer.invoke('buscarCaixaPorId', ...args),
  buscarTodosCaixas: (
    ...args: Parameters<BuscarTodosCaixas>
  ): ReturnType<BuscarTodosCaixas> =>
    ipcRenderer.invoke('buscarTodosCaixas', ...args),
}

export const apiConta = {
  criarConta: (...args: Parameters<CriarConta>): ReturnType<CriarConta> =>
    ipcRenderer.invoke('criarConta', ...args),
  ...
  buscarContaPorId: (
    ...args: Parameters<BuscarContaPorId>
  ): ReturnType<BuscarContaPorId> =>
    ipcRenderer.invoke('buscarContaPorId', ...args),
  buscarTodasContas: (
    ...args: Parameters<BuscarTodasContas>
  ): ReturnType<BuscarTodasContas> =>
...
export const apiEstoque = {
  ...
  removerEstoque: (
    ...args: Parameters<RemoverEstoque>
  ): ReturnType<RemoverEstoque> =>
    ipcRenderer.invoke('removerEstoque', ...args),
  editarEstoque: (
    ...args: Parameters<EditarEstoque>
  ): ReturnType<EditarEstoque> => ipcRenderer.invoke('editarEstoque', ...args),
  buscarEstoquePorId: (
    ...args: Parameters<BuscarEstoquePorId>
  ): ReturnType<BuscarEstoquePorId> =>
    ipcRenderer.invoke('buscarEstoquePorId', ...args),
  buscarTodosEstoques: (
    ...args: Parameters<BuscarTodosEstoques>
  ): ReturnType<BuscarTodosEstoques> =>
    ipcRenderer.invoke('buscarTodosEstoques', ...args),
  buscarEstoquesNaoVendidos: (
    ...args: Parameters<BuscarEstoquesNaoVendidos>
  ): ReturnType<BuscarEstoquesNaoVendidos> =>
    ipcRenderer.invoke('buscarEstoquesNaoVendidos', ...args),
}

export const apiVenda = {
  criarVenda: (...args: Parameters<CriarVenda>): ReturnType<CriarVenda> =>
    ipcRenderer.invoke('criarVenda', ...args),
  ...
  buscarVendaPorId: (
    ...args: Parameters<BuscarVendaPorId>
  ): ReturnType<BuscarVendaPorId> =>
